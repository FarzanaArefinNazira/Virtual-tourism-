    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(bookcar.this, android.R.style.Theme_DeviceDefault_Dialog, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            bkc user = new bkc(email, name, dateofbirth, phonenumber);
                            ...
                            FirebaseDatabase.getInstance().getReference("users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(bookcar.this, "User has been registered successfully!", Toast.LENGTH_LONG).show();
                                        mprogressBar.setVisibility(View.VISIBLE);
                                        startActivity(new Intent(bookcar.this, Lo.class));
                                    } else {
                                        Toast.makeText(bookcar.this, "Failed to register! Try Again!", Toast.LENGTH_LONG).show();
                                        mprogressBar.setVisibility(View.VISIBLE);
